...
NIFTY_UNIVERSE = [
    ...
    "BAJAJ-AUTO", "TATAMOTORS", "TATASTEEL", "HAL", "GRASIM", "DMART",
    ...
    "GODREJPROP", "OBEROIRLTY", "ZOMATO", "PAYTM", "NAUKRI", "INDIGO",
    "PIIND", "SRF", "UPL", "BEL", "BHEL", "IRCTC", "IRFC", "RVNL",
    "HAVELLS", "VOLTAS", "CROMPTON", "BOSCHLTD", "MOTHERSON", "MRF",
    "BALKRISNIND", "ASHOKLEY", "TVSMOTOR", "HEROMOTOCO", "BANDHANBNK",
    "FEDERALBNK", "IDFCFIRSTB", "AUBANK", "CHOLAFIN", "MUTHOOTFIN",
    "LTIM", "PERSISTENT", "COFORGE", "MPHASIS", "LTTS", "TATACOMM",
    "COLPAL", "MARICO", "BERGEPAINT", "PAGEIND", "JUBLFOOD", "UBL",
    "MCDOWELL-N", "VBL", "TORNTPHARM", "LUPIN", "AUROPHARMA", "ALKEM",
